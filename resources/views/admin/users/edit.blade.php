                    ...
                    <form action="{{ route('users.update', $user->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name"
                                class="w-full border-gray-300 text-black rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="role" id="role"
                                class="w-full text-black border-gray-300 rounded-lg shadow-sm text-black focus:ring-blue-500 focus:border-blue-500">
